...
<?php else: ?>
    ...
    <div class="order-box__header order-box__header_normal"><?=
        Yii::t(
            "CartModule.cart",
            "Delivery method"
        ); ?></div>
                                                        ...
                                                        <span class="rich-radio-body__title">
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                - согласно тарифам <a
                                                                    ...
                                                                    href="http://www.pochta.ru">www.pochta.ru</a>
                                                            <?php endif; ?>
                                                            <?php if ($delivery->free_from > 0): ?>
                                                                <span class="rich-radio-body__free-from-text">
                                                                Бесплатно при заказе от <?= number_format($delivery->free_from, 0, ".", " ") . " "; ?>
                                                                    <span class="ruble"> <?=
                                                                        Yii::t(
                                                                            "CartModule.cart",
                                                                            "RUB"
    ...
    <div class="order-box__bottom">
        <div class="cart-box__subtotal">
            ...
            товар(а) на сумму &nbsp;<span id="cart-full-cost-with-shipping">0</span><span class="ruble"> <?=
                Yii::t(
                    "CartModule.cart",
                    "RUB"
                ); ?></span>
        ...
        <div class="cart-box__order-button">
            <button type="submit" class="btn_cart btn btn_big btn_primary"><?=
                Yii::t(
                    "CartModule.cart",

...
<div id="dialog-confirm" title="Отзыв о <?= CHtml::encode($product->name); ?>">
    <div class="b-modal-reviews">
        ...
        <form action="" id="b-modal__form">
            ...
            <div class="b-modal-reviews__footer">
                <div class="b-modal-reviews__name">
                    <label class="b-modal-reviews__label" for="modal__name">Как вас зовут ?</label>
                    <br>
                    <input type="text" id="modal__rating" name="modal__rating" hidden>
                    <input id="modal__name" name="modal__name" type="text" class="b-modal-reviews__input" required>
                </div>
                <div class="b-modal-reviews__city">
                    <label class="b-modal-reviews__label" for="modal__city">Ваш город ?</label>
                    <br>
                    <input id="modal__city" name="modal__city" type="text" class="b-modal-reviews__input">
                </div>
            </div>

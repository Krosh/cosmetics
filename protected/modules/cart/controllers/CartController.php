...
class CartController extends \yupe\components\controllers\FrontController
{
    ...
    public function actionAdd()
    {
        ...
        Yii::app()->ajax->success(Yii::t("CartModule.cart", 'Product successfully added to your basket').'<br><a href = "'.$this->createUrl("/cart").'" class = "btn btn_success">Оформить заказ</a>');
    }

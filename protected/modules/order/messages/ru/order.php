...
return [
    ...
    'Completed' => 'Выполнен',
    'Country' => 'Страна',
    'Coupon code' => 'Код промокода',
    'Coupon will be deleted after save' => 'При сохранении промокод будет удален',
    'Coupons' => 'Промокоды',
    ...
    'Delivery' => 'Доставка',
    'Discount (%)' => 'Скидка (%)',
    'Discount coupon' => 'Скидка с промокода',
    ...
    'In stock' => 'В наличии',
    'Inform buyer about order status by email' => 'Оповестить покупателя о состоянии заказа по Email',
    'Inform buyer about order status by sms' => 'Оповестить покупателя о состоянии заказа по Смс',

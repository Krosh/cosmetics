...
class StoreImage
{
    ...
    public static function ingredient(Ingredient $ingredient, $width = 0, $height = 0, $crop = true)
    {
        return $ingredient->getImageUrl($width, $height, $crop, static::getDefaultImage());
    }

<?php
/**
 * MegareviewModule основной класс модуля megareview
 *
 * @author yupe team <team@yupe.ru>
 * @link http://yupe.ru
 * @copyright 2009-2016 amyLabs && Yupe! team
 * @package yupe.modules.megareview
 * @since 0.1
 */

class MegareviewModule extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('MegareviewModule.megareview', 'Content');
    }
    ...
    {
        return Yii::t('MegareviewModule.megareview', self::VERSION);
    }
    ...
    {
        return Yii::t('MegareviewModule.megareview', 'http://yupe.ru');
    }
    ...
    {
        return Yii::t('MegareviewModule.megareview', 'megareview');
    }
    ...
    {
        return Yii::t('MegareviewModule.megareview', 'Описание модуля "megareview"');
    }
    ...
    {
        return Yii::t('MegareviewModule.megareview', 'yupe team');
    }
    ...
    {
        return Yii::t('MegareviewModule.megareview', 'team@yupe.ru');
    }
    ...
    {
        return '/megareview/megareviewBackend/index';
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Megareview.MegareviewManager',
                'description' => Yii::t('MegareviewModule.megareview', 'Manage megareview'),
                'type' => AuthItem::TYPE_TASK,
                'items' => [
                    [
                        'type' => AuthItem::TYPE_OPERATION,
                        'name' => 'Megareview.MegareviewBackend.Index',
                        'description' => Yii::t('MegareviewModule.megareview', 'Index')
                    ],
                ]
            ]
        ];
